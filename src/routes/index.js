...
export default function Routers() {
    ...
    return (
        <Routes>
            ...
            <Route exact path="/CadastroProdutos" element={<CadastroProdutos validation={validation} 
                setValidation={setValidation}/>} 
            />

            <Route exact path="/Main" element={<TelaMain validation={validation} 
                setValidation={setValidation}/>} 
            />

            <Route exact path="/Dia" element={<Dia validation={validation} 
                setValidation={setValidation}/>} 
            />

            <Route exact path="/Semana" element={<Semana validation={validation} 
                setValidation={setValidation}/>} 
            />
            
            <Route exact path="/Search" element={<Search validation={validation} 
                setValidation={setValidation}/>} 
            />
        </Routes>
    )
