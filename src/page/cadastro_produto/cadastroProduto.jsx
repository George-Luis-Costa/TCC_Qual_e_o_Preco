...
export const CadastroProduto = () => {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            ...
            price: yup.number().max(1000, "*No máximo 4 dígitos (6 algarismos -> 1000.00)").required("*Obrigatório").typeError("*Por favor coloque um número Válido. No máximo 4 dígitos (6 algarismos -> 1000.00)***Utilize ponto para casas decimais***"),
